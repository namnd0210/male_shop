									...
									<form action="" id="search_lucky" method="get">
										<div class="row">
											<div class="col-md-3 col-lg-3">
												...
												?>
												<input type="text" name="name" id="name" value="<?php if($name != null) echo $name ?>" placeholder="Tên khách hàng" class="form-control">
											</div>
											<div class="col-md-3 col-lg-3">
												<?php
													$phone = null;
												...
												?>
												<input type="text" name="phone" id="phone" value="<?php if($phone != null) echo $phone ?>" placeholder="Số điện thoại" class="form-control">
											</div>
											<div class="col-md-3 col-lg-3">
											<?php
												$from_date = null;
											...
											?>
												<input type="date" placeholder="Từ ngày" class="form-control" name="from_date" id="from_date" value="<?php if($from_date != null) echo $from_date?>" max="<?php echo date("Y-m-d") ?>">
											</div>
											<div class="col-md-3 col-lg-3">
											<?php
												$to_date = '';
											...
											?>
												<input type="date" placeholder="Đến ngày" class="form-control" name="to_date" id="to_date" value="<?php if($to_date != null) echo $to_date ?>" max="<?php echo date("Y-m-d") ?>">	
											</div>
										</div>
									...
									<div class="row">
										...
										<div class="col-md-3 col-lg-3">
											<a href="create_order.php">
												<button class="btn btn-primary mr-2"><i class="fa fa-plus"></i> Thêm mới</button>
											</a>	
										</div>
									</div>
								</div>
											...
											<tr>
												...
												<td> 
													<?php if($item['user_id'] != null){?>
														<a href="update_order.php?order_id=<?php echo $item['id']?>" class="btn btn-warning mb-2">
															<i class="fa fa-edit pd-1"></i> 
														</a>
													<?php } ?>
													<?php if($item['status'] == 1){?>
														<a href="controller/confirm_order.php?order_id=<?php echo $item['id']?>" class="confirm_order"> <button class="btn btn-info mb-2">Duyệt</button> </a>
													<?php } ?>
													<?php if($item['delivery_status'] != 4){?>
														<a href="controller/cancel_order.php?order_id=<?php echo $item['id']?>" class="cancel_order"> <button class="btn btn-danger mb-2">Hủy</button> </a>
													<?php } ?>
													<a href="controller/delete_order.php?order_id=<?php echo $item['id']?>" class="btn btn-danger delete_order"> <i class="fa fa-trash pd-1"></i> </a>
												</td>
											</tr>
										<?php $dem++; }?>
									</tbody>
